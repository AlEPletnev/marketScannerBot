...
@Component
public class CommandSetScanOnWeek implements Command {

    private final String TEXT_COMMAND = "/setScanOnWeek";
    ...
    public String processCommand() {
        timeFrameScanningStorage.setTimeFrameForScanning(ByBitInterval.WEEK);
